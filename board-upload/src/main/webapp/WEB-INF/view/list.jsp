...
<body>
	...
	<div class="d-flex justify-content-center">
		...
		<!-- page -->
			<c:forEach var="i" begin="0" end="${page_count - 1 }" step="1">
		...
		<!-- Next -->
			<c:if test = "${startNum + page_count <= lastNum}">
				<li class="page-item"><a class="page-link" href="list.do?p=${startNum+page_count }">Next</a></li>
			</c:if>
			<c:if test = "${startNum + page_count > lastNum }">
